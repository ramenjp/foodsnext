...
import com.dev_training.form27.AccountPasswordUpdateForm;
import com.dev_training.service27.AccountPasswordUpdateService;
 ...
 */
@Controller
@RequestMapping(value = "/top/password")
public class AccountPasswordUpdateController {
    ...
    public String registerConfirm(@ModelAttribute @Validated AccountPasswordUpdateForm accountPasswordUpdateForm, BindingResult bindingResult) {
        ...
        boolean isValid = service.validCurrentPassword(account.getAccountId(), accountPasswordUpdateForm.getCurrentPassword());
        if (!isValid) {
            bindingResult.reject("validation.current.password", "default message");
            return "account/accountPasswordUpdateForm";
        }
        service.updatePassword(account.getAccountId(), accountPasswordUpdateForm.getNewPassword());
